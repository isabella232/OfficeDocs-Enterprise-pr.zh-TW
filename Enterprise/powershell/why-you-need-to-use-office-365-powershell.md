...
- Office 365 PowerShell 十分適合執行大量作業
    
- Office 365 PowerShell 十分適合篩選資料
    
- Office 365 PowerShell 可讓您輕鬆地列印或儲存資料
    
- Office 365 PowerShell 可讓您管理數個伺服器產品
...
在 SharePoint Online 中，您也可以執行此命令來計算所有 Web 應用程式之所有網站的所有清單中的項目數：
