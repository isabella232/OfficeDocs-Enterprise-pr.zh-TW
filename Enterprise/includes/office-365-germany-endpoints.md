...
4 | 預設<BR>必要 | 否 | `autodiscover-outlook.office.de` | **TCP：** 443、80
...
28 | 預設<BR>必要 | 否 | `*.cloudfront.net, agent.office.de, clientlog.portal.office.de, commerceapi.office.de, prod.msocdn.de, r1.res.office365.com, shellprod.msocdn.de, videoplayer.osi.office.net` | **TCP：** 443、80
...
30 | 預設<BR>必要 | 否 | `graph.microsoft.de, microsoftonline.de, ocws.osi.office.de, odc.osi.office.de, osi.office.de, roaming.osi.office.de, sharepoint.de, store.office.de, wordsgs.osi.office.de` | **TCP：** 443、80
