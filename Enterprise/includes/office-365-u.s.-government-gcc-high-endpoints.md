...
10  | 預設<BR>必要 | 否 | `*.wns.windows.com, admin.onedrive.us, ajax.aspnetcdn.com, g.live.com, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms` | **TCP：** 443、80
...
17  | 允許<BR>必要 | 是 | `*.osi.office365.us, tasks.office365.us`<BR>`52.127.240.0/20, 2001:489a:2206::/48` | **TCP：** 443
...
22 | 允許<BR>必要 | 是 | `gcchigh.loki.office365.us`<BR>`52.127.240.40/32, 52.127.244.46/32` | **TCP：** 443
23 | 預設<BR>必要 | 否 | `*.office365.us` | **TCP：** 443、80
