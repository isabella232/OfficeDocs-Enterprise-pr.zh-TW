...
20 | 預設<BR>必要 | 否 | `*.svc.ms, az741266.vo.msecnd.net, pf.pipe.aria.microsoft.com, spoprod-a.akamaihd.net, static.sharepointonline.com` | **TCP：** 443、80
...
25 | 預設<BR>必要 | 否 | `*.cdn.office.net` | **TCP：** 443
