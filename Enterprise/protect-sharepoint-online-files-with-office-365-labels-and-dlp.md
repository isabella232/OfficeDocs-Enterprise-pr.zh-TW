...
## <a name="office-365-labels-for-your-sharepoint-online-sites"></a>SharePoint Online 網站的 office 365 標籤

若要建立的三個階段，然後指派 Office 365 標籤至 SharePoint Online 小組網站。
  
### <a name="phase-1-determine-the-office-365-label-names"></a>階段 1： 判斷 Office 365 標籤名稱
...
2. 新**SharePoint** ] 索引標籤上瀏覽器中，按一下 [需要指派 Office 365 標籤的網站]。
...
## <a name="dlp-policies-for-your-sharepoint-online-sites"></a>SharePoint Online 網站的 DLP 原則
