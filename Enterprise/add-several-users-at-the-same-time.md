...
1. 下載[此範例試算表](https://www.microsoft.com/download/details.aspx?id=45485)，並在 Excel 中開啟。 
...
8. 步驟 3 - 設定，請選擇 **[已允許]**，允許試算表所列的人員使用 Office 365。 另外也請選擇這些人會使用 Office 365 的國家/地區。 請記住，如果組織中的某些人要在其他國家/地區使用 Office 365，請以他們的名稱另外建立一份試算表，然後再次執行 [大量新增使用者] 精靈，新增他們。
