...
如果您使用 Office 2007 產品和服務、，支援的結束這些應用程式。在您規劃升級時，這是更好的時間考量移至 Microsoft Cloud，開始使用 Office 365。使用當做起點本文檢閱您的選項及規劃升級。
...
|[從 Office Communications Server 升級](https://docs.microsoft.com/SkypeForBusiness/plan-your-deployment/upgrade) <br/> |2018 年 1 月 8 日  <br/> |
