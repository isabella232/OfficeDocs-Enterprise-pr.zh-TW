...
如果您只是要建立的最低需求的輕量型方式隔離的 SharePoint Online 小組網站，請在階段 2 和 3 的[Office 365 開發人員/測試環境](office-365-dev-test-environment.md)中遵循的指示。
  
如果您想要建立隔離的 SharePoint Online 小組網站中的模擬的企業設定，請遵循[DirSync Office 365 開發人員/測試環境](dirsync-for-your-office-365-dev-test-environment.md)中的指示。
