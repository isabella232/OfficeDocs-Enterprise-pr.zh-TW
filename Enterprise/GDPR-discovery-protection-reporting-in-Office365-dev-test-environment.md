...
首先，請遵循 [Office 365 開發/測試環境階段 2](office-365-dev-test-environment.md#phase-2-create-an-office-365-trial-subscription) 一文中的步驟進行。
...
附註： 為此範例資料集從公開提供的資訊和適用於僅供測試。

3. 在您瀏覽器的新索引標籤中，輸入：**https://**\<您的租用戶名稱\>**.sharepoint.com**
...
Office 365 中個人資訊的保護，包括使用資料外洩防護 (DLP) 功能。使用 Office 365 安全性與合規性中心的 DLP 原則時，您可以自動保護整個 Office 365 中的敏感資訊。
...
21. 在 [網址] 列中輸入：**https://outlook.office365.com**
