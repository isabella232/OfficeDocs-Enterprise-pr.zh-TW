...
<span data-ttu-id="9d904-109">] 索引標籤的功能包括：</span><span class="sxs-lookup"><span data-stu-id="9d904-109">The features and tabs are:</span></span> 
...
3. <span data-ttu-id="9d904-128">在 [列印設定]\*\*\*\* 索引標籤的 [印表機紙張]\*\*\*\* 區段中，選取想要在其上列印的紙張大小。</span><span class="sxs-lookup"><span data-stu-id="9d904-128">On the **Print Setup** tab, in the **Printer paper** section, select the size of paper you want to print on.</span></span>
...
- <span data-ttu-id="9d904-146">Exchange</span><span class="sxs-lookup"><span data-stu-id="9d904-146">Exchange</span></span>
...
### <a name="office-web-apps-server"></a><span data-ttu-id="9d904-170">Office Web Apps Server</span><span class="sxs-lookup"><span data-stu-id="9d904-170">Office Web Apps Server</span></span>
...
### <a name="server-to-server-trust-relationships"></a><span data-ttu-id="9d904-184">伺服器對伺服器信任關係</span><span class="sxs-lookup"><span data-stu-id="9d904-184">Server-to-server trust relationships</span></span>
...
- <span data-ttu-id="9d904-200">Https:// JSON 中繼資料端點與 Lync server<server name>/metadata/json/1</span><span class="sxs-lookup"><span data-stu-id="9d904-200">A Lync server with a JSON metadata endpoint of https://<server name>/metadata/json/1</span></span> 
...
### <a name="larger-profile-picture-used-across-all-office-applications"></a><span data-ttu-id="9d904-213">較大用於所有 Office 應用程式的設定檔圖片</span><span class="sxs-lookup"><span data-stu-id="9d904-213">Larger profile picture used across all Office applications</span></span>
...
- <span data-ttu-id="9d904-232">使用 Windows PowerShell 設定與 Exchange 的照片同步處理。</span><span class="sxs-lookup"><span data-stu-id="9d904-232">Use Windows PowerShell to configure photo sync with Exchange.</span></span> 
...
2. <span data-ttu-id="9d904-248">使用者可以使用數種不同的方式，來更新相片：</span><span class="sxs-lookup"><span data-stu-id="9d904-248">The user can use several different ways to update a photo:</span></span> 
...
<span data-ttu-id="9d904-260">整合連絡人存放區 (UCS) 提供數個 Microsoft Office 產品的一致聯絡體驗。</span><span class="sxs-lookup"><span data-stu-id="9d904-260">Unified contact store (UCS) provides a consistent contact experience across Microsoft Office products.</span></span> <span data-ttu-id="9d904-261">使用者將所有聯絡人資訊儲存在 Exchange 2013 信箱。</span><span class="sxs-lookup"><span data-stu-id="9d904-261">Users store all contact information in their Exchange 2013 mailbox.</span></span> <span data-ttu-id="9d904-262">相同的連絡資訊皆可全域使用跨 Lync、 Exchange、 Outlook 和 Outlook Web App。</span><span class="sxs-lookup"><span data-stu-id="9d904-262">The same contact information is available globally across Lync, Exchange, Outlook and Outlook Web App.</span></span> 
 ...
 <span data-ttu-id="9d904-263">**伺服器產品**</span><span class="sxs-lookup"><span data-stu-id="9d904-263">**Server products**</span></span>
...
- <span data-ttu-id="9d904-296">在 SharePoint 伺服器陣列中設定 app management service 應用程式。</span><span class="sxs-lookup"><span data-stu-id="9d904-296">Configure the app management service application in the SharePoint farm.</span></span> 
...
### <a name="provisioning-and-management"></a><span data-ttu-id="9d904-312">佈建和管理</span><span class="sxs-lookup"><span data-stu-id="9d904-312">Provisioning and management</span></span>
...
- <span data-ttu-id="9d904-345">需要安全通訊端層 (SSL)。</span><span class="sxs-lookup"><span data-stu-id="9d904-345">Secure Sockets Layer (SSL) is required.</span></span> 
...
- <span data-ttu-id="9d904-361">Search Service 應用程式。</span><span class="sxs-lookup"><span data-stu-id="9d904-361">Search Service application.</span></span> 
...
- <span data-ttu-id="9d904-381">會決定使用者的下一個批次。</span><span class="sxs-lookup"><span data-stu-id="9d904-381">Determines the next batch of users.</span></span> 
...
- <span data-ttu-id="9d904-396">Lync Server 2013</span><span class="sxs-lookup"><span data-stu-id="9d904-396">Lync Server 2013</span></span> 
...
- <span data-ttu-id="9d904-430">來電者起始的呼叫中使用 Lync 2013。</span><span class="sxs-lookup"><span data-stu-id="9d904-430">The caller initiates a call using Lync 2013.</span></span> 
...
<span data-ttu-id="9d904-465">海報包含兩個不同案例的兩個圖表：</span><span class="sxs-lookup"><span data-stu-id="9d904-465">The poster includes two diagrams for two different scenarios:</span></span> 
...
<span data-ttu-id="9d904-470">小組網站包含：</span><span class="sxs-lookup"><span data-stu-id="9d904-470">The Team site contains:</span></span> 
  
- <span data-ttu-id="9d904-471">資產庫應用程式。</span><span class="sxs-lookup"><span data-stu-id="9d904-471">The Asset Library app.</span></span> 
    
- <span data-ttu-id="9d904-472">會議資產庫的小組成員傳送會議錄製。</span><span class="sxs-lookup"><span data-stu-id="9d904-472">Meetings asset library, to which team members send meeting recordings.</span></span> 
    
<span data-ttu-id="9d904-473">在管理中心系統管理中心包含 web 應用程式一般設定。</span><span class="sxs-lookup"><span data-stu-id="9d904-473">The Central Administration Center contains web application general settings.</span></span> 
  
<span data-ttu-id="9d904-474">IIS 伺服器皆包含 IIS 設定。</span><span class="sxs-lookup"><span data-stu-id="9d904-474">The IIS Server contains IIS settings.</span></span> 
  
<span data-ttu-id="9d904-475">若要準備發佈會議錄製：</span><span class="sxs-lookup"><span data-stu-id="9d904-475">To prepare for publishing meeting recordings:</span></span> 
  
1. <span data-ttu-id="9d904-476">在 SharePoint 小組網站，新增 [資產庫應用程式]。</span><span class="sxs-lookup"><span data-stu-id="9d904-476">On your SharePoint team site, add the Asset Library app.</span></span> <span data-ttu-id="9d904-477">（選用） 如果您是無法上載會議錄製內容，因為大小限制或連線逾時，執行額外步驟 2 和 3。</span><span class="sxs-lookup"><span data-stu-id="9d904-477">Optionally, if you are unable to upload meeting recordings due to size restrictions or connection timeouts, perform the additional steps 2 and 3.</span></span> 
    
2. <span data-ttu-id="9d904-478">在 SharePoint 管理中心內，變更 [最大上傳大小] 設定，包含您的小組網站集合的 web 應用程式。</span><span class="sxs-lookup"><span data-stu-id="9d904-478">In the SharePoint Central Administration, change the maximum upload size setting for the web application that contains your team site collection.</span></span> 
    
3. <span data-ttu-id="9d904-479">在 IIS 伺服器設定]，增加 IIS 連線逾時，包含您的小組網站集合的網站。</span><span class="sxs-lookup"><span data-stu-id="9d904-479">In the IIS Server settings, increase the IIS connection timeout for the web site that contains your team site collection.</span></span> 
    
 <span data-ttu-id="9d904-480">**數位資產庫**</span><span class="sxs-lookup"><span data-stu-id="9d904-480">**Digital asset libraries**</span></span>
  
<span data-ttu-id="9d904-481">數位資產庫是包含影響特定的容量和效能的影片的資產庫。</span><span class="sxs-lookup"><span data-stu-id="9d904-481">Digital asset libraries are asset libraries that contain videos that have certain capacity and performance implications.</span></span> <span data-ttu-id="9d904-482">如需詳細資訊，請參閱位於 SharePoint Server 2013 中的規劃數位資產庫http://aka.ms/O1vq5w。</span><span class="sxs-lookup"><span data-stu-id="9d904-482">For more information, see Plan digital asset libraries in SharePoint Server 2013 located at http://aka.ms/O1vq5w.</span></span> <span data-ttu-id="9d904-483">海報也包含 QR 碼，來存取這項資訊。</span><span class="sxs-lookup"><span data-stu-id="9d904-483">The poster also includes a QR code to access this information.</span></span> 
  
### <a name="recording-and-publishing-a-meeting-using-the-lync-client"></a><span data-ttu-id="9d904-484">錄製及發佈使用 Lync 用戶端的會議</span><span class="sxs-lookup"><span data-stu-id="9d904-484">Recording and publishing a meeting using the Lync client</span></span>

<span data-ttu-id="9d904-485">此圖顯示使用 Lync 加入會議的使用者。</span><span class="sxs-lookup"><span data-stu-id="9d904-485">The diagram shows a user using Lync to join a meeting.</span></span> <span data-ttu-id="9d904-486">使用 Lync 用戶端，它會 MP4 檔案建立與會議內容會錄製會議。</span><span class="sxs-lookup"><span data-stu-id="9d904-486">The meeting is recorded using the Lync client, which creates an MP4 file with the meeting content.</span></span> <span data-ttu-id="9d904-487">MP4 錄製會儲存到 Lync 錄製資料夾，在您的電腦上。</span><span class="sxs-lookup"><span data-stu-id="9d904-487">The MP4 recording is saved to the Lync recording folder on your computer.</span></span> <span data-ttu-id="9d904-488">您可以移動 MP4 錄製會議資產文件庫，從中您可以將它插入 wiki、 SharePoint] 頁面上或部落格。</span><span class="sxs-lookup"><span data-stu-id="9d904-488">You can move the MP4 recording to your meetings asset library, from which you can insert it into a wiki, SharePoint page, or blog.</span></span> 
  
 <span data-ttu-id="9d904-489">**記錄及發佈使用 Lync 用戶端的會議**</span><span class="sxs-lookup"><span data-stu-id="9d904-489">**To record and publish a meeting using the Lync client**</span></span>
  
1. <span data-ttu-id="9d904-490">開始錄製使用 Lync 用戶端的會議。</span><span class="sxs-lookup"><span data-stu-id="9d904-490">Start recording the meeting using the Lync client.</span></span> 
    
2. <span data-ttu-id="9d904-491">會議內容會在會議期間記錄至 MP4 檔案。</span><span class="sxs-lookup"><span data-stu-id="9d904-491">The meeting content is recorded into an MP4 file during the meeting.</span></span> 
    
3. <span data-ttu-id="9d904-492">MP4 錄製會議結束之後，會顯示在您的電腦上的 [錄製] 資料夾 (c:\\使用者\\<username>\\影片\\Lync 錄製)。</span><span class="sxs-lookup"><span data-stu-id="9d904-492">After the meeting concludes, the MP4 recording appears in the recording folder on your computer (C:\\Users\\<username>\\Videos\\Lync Recordings).</span></span> <span data-ttu-id="9d904-493">或者，您可以自訂使用 Lync 錄製管理員應用程式可取得安裝 Lync 用戶端與會議錄製。</span><span class="sxs-lookup"><span data-stu-id="9d904-493">Optionally, you can customize the meeting recording using the Lync Recording Manager app which gets installed with Lync client.</span></span> 
    
4. <span data-ttu-id="9d904-494">拖放到您的 SharePoint 資產庫錄製會議。</span><span class="sxs-lookup"><span data-stu-id="9d904-494">Drag and drop the meeting recording into your SharePoint asset library.</span></span> 
    
5. <span data-ttu-id="9d904-495">選用： 資產庫中錄製之後，您可以插入其在任何 SharePoint] 頁面上。</span><span class="sxs-lookup"><span data-stu-id="9d904-495">Optional: Once the recording is in your asset library, you can insert it in any SharePoint page.</span></span> <span data-ttu-id="9d904-496">如需此步驟的詳細資訊，請參閱 Office 365 部落格項目，建立及發佈開發人員訓練影片與 SharePoint 和 Lync Online 中，位於http://aka.ms/R61q35。</span><span class="sxs-lookup"><span data-stu-id="9d904-496">For more information about this step, see the Office 365 blog entry, Create and Publish Training Videos with SharePoint and Lync Online, located at http://aka.ms/R61q35.</span></span> 
    
 <span data-ttu-id="9d904-497">**視訊縮圖**</span><span class="sxs-lookup"><span data-stu-id="9d904-497">**Video thumbnails**</span></span>
  
<span data-ttu-id="9d904-498">視訊縮圖改善資產庫的外觀與風格。</span><span class="sxs-lookup"><span data-stu-id="9d904-498">Video thumbnails improve the look and feel of your asset library.</span></span> <span data-ttu-id="9d904-499">若要深入了解建立您的會議錄製的縮圖，請參閱 < Capture 或變更視訊的縮圖中，位於<b0></b0>。</span><span class="sxs-lookup"><span data-stu-id="9d904-499">To learn more about creating thumbnails for your meeting recordings, see Capture or change a video thumbnail, located at http://aka.ms/Kupj85.</span></span> <span data-ttu-id="9d904-500">海報也包含 QR 碼，來存取這項資訊。</span><span class="sxs-lookup"><span data-stu-id="9d904-500">The poster also includes a QR code to access this information.</span></span> 
